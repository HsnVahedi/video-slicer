        ...
        <div className="fixed inset-0 flex items-center justify-center z-50">
          ...
          <div className="bg-white rounded-lg shadow-xl p-6 max-w-md w-full z-10 relative">
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Processing Video</h3>
              <p className="text-gray-600 text-center mb-2">Generating your video slices. This might take a while.</p>
              <p className="text-gray-600 text-center font-bold">Please wait and make sure to keep this window open.</p>
            </div>
          </div>
        </div>
      )}
